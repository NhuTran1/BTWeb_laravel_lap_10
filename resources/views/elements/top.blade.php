    ...
    <div class="grid">
        <nav class="header__navbar">
            <ul class="header__navbar-list">
                <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
                    ...
                    <div class="header__qr">
                        <img src="./asset/img/QRCodeshopee.png" alt="QR CODE" class="header__qr-img">
                        <div class="header__qr-apps">
                            <a href="" class="header__qr-link">
                                <img src="./asset/img/ggplay.png" alt="App store"
                                    class="header__qr-download-img">
                            </a>
                            <a href="" class="header__qr-link">
                                <img src="./asset/img/appstore.png" alt="Google Play"
                                    class="header__qr-download-img">
                            </a>
                ...
                <li class="header__navbar-item">
                    ...
                    <a href="" class="header__navbar-icon-link">
                        <i class="header__nav-icon fa-brands fa-instagram"></i>
                    </a>
                </li>
            </ul>
            ...
            <ul class="header__navbar-list">
                        ...
                        <ul class="header__notify-list">
                            <li class="header__notify-item header__notify-item--viewed">
                                <a href="" class="header__notify-link">
                                    <img src="./asset/img/mypham.jpg" alt="" class="header__notify-img">
                ...
                <li class="header__navbar-item">
                    <a href="" class="header__navbar-item-link">
                        <i class="header__nav-icon fa-solid fa-question"></i>
                        Trợ giúp
                    </a>
                </li>
                ...
                <li class="header__navbar-item header__navbar-user">
                    <img src="./asset/img/avata.jpeg" alt="" class="header__navbar-user-img">
                    <span class="header__navbar-user-name">Quang Như</span>
            ...
            <div class="header__cart">
                <div class="header__cart-wrap">
                    ...
                    <div class="header__cart-list ">
                        <img src="./asset/img/cart_empty.jpg" alt="" class=" header__cart-list-no-cart-img">
                        ...
                        <ul class="header__cart-list-item">
                            ...
                            <li class="header__cart-item">
                                <img src="./asset/img/sp1.jpg" alt="" class="header__cart-img">
                                <div class="header__cart-item-info">
                                    <div class="header__cart-item-head">
                                        <h5 class="header__cart-item-name">Lồng đèn Handmade</h5>
